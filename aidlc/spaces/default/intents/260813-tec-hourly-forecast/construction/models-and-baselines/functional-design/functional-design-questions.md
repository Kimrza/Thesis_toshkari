...
**What changed in this unit since the last receipt.** `PartitionError` declaration-site ruling recorded — this unit stays the exception's **semantic owner** (R-92's discriminating rule unchanged) but is no longer its declaration site; **G-09 signed (D-31)**.
