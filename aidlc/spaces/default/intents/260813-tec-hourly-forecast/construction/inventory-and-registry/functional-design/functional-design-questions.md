...
**What changed in this unit since the last receipt.** `provenance_class` rebasing completed at the **three** sites the original remediation left stale (only one of five had been rebased); counts recorded as a **dated observation, not a live invariant**; **G-09 signed (D-31)**.
