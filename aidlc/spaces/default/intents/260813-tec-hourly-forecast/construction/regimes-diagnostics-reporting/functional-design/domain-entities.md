...
- **Routing**: the checklist is the evidence the Vision §15.2 rows
  (FR-P1-05-20, FR-P1-05-19, `TST-CLAIMS-01`) point at. ⛔ **The rows were APPROVED under D-32
  (2026-08-28)** — board option 1, all eight approved, none deferred — and are now **`Pending`:
  approved, never run, NOT passed.** *(Corrected 2026-08-30 on the second adversarial iteration's
  Critical finding; superseded: "the **candidate** Vision §15.2 rows … would point at —
  **proposed at the gate, never applied here**".)* The approval was the owner's act; this stage
  minted no row, and an approved-but-unrun row is not evidence.
...
| FR-P1-05-16 | § 3 (including the §5.5 metric fields and the tier-3 row) | ⚠ **`Pending` — §15.2 row APPROVED under D-32 (2026-08-28), never run; NOT passed.** **Unchanged: the §5.5 metric-set re-citation is owed upstream** (`TEC-14`, Open). *(Corrected 2026-08-30, adversarial finding 1, Critical; superseded: "⚠ no row — candidate §15.2 row a gate item".)* |
| FR-P1-05-18 | § 3 (`DEC` regime rows), § 5 (`RegimeError`) | ⚠ **`Pending` — §15.2 row APPROVED under D-32 (2026-08-28), never run; NOT passed.** Advisory NOT-READY on the source criterion still **reported, not fixed**. *(Corrected 2026-08-30, adversarial finding 1; superseded: "⚠ no row — candidate row a gate item".)* |
| FR-P1-05-19 | § 2, § 6 (the registered surface its three locations resolve against) | ⚠ **`Pending` — §15.2 row APPROVED under D-32 (2026-08-28), never run; NOT passed.** *(Corrected 2026-08-30, adversarial finding 1; superseded: "⚠ no row — named candidate; §15.2 row a gate item".)* |
| FR-P1-05-20 | § 1 (`beats_model` per row), § 2 (the conclusion row), § 6 (its declared subject) | ⚠ **`Pending` — §15.2 row APPROVED under D-32 (2026-08-28), never run; NOT passed.** D-32 approved **all eight** §15.2 rows, none deferred. *(Corrected 2026-08-30, adversarial finding 1; superseded: "⚠ no row — named candidate; §15.2 row a gate item".)* |
| REQ-CLAIM-01 | § 2 (including the D-28 scored-set disclosure row) | ⚠ **`Pending` — `TST-CLAIMS-01` row APPROVED under D-32 (2026-08-28), never run; NOT passed.** *(Corrected 2026-08-30, adversarial finding 1; superseded: "⚠ no row — `TST-CLAIMS-01` has no §16/§19 row; §15.2 row a gate item".)* **Unchanged and still owed: `REQ-CLAIM-01`'s own "tested on December 2022 only" text is a completed-stage artifact, not edited here** — owed an owner-approved annotate-in-place or a Vision §15.2 amendment (Rec 16 follow-on) |

**11 requirements, 7 carrying no result** — of which **5 now hold a `Pending` §15.2 row approved under D-32** (FR-P1-05-16, -18, -19, -20, `REQ-CLAIM-01`/`TST-CLAIMS-01`) and **2 still have no row at all** (FR-P1-05-14, FR-P1-05-15). ⚠ *(Corrected 2026-08-30 on adversarial finding 1, Critical; superseded: "**11 requirements, 7 untested — derived from the story map's rows.**" The count of requirements without a result is unchanged at **7**; what changed is that five of the seven are no longer rowless. **None of the seven is passed** — an approved-but-unrun row and an absent row are both `Pending`, and neither is evidence.)* Derived from the story map's rows. **6 entities**
...
- **G-09 is not signed.** ⚠ **G-09 IS SIGNED as of 2026-08-28 (D-31)** — this prohibition's stated ground no longer holds, and module creation is authorised. **The other grounds stated alongside it, if any, are untouched**, and D-31's disclosure travels with the signature: the §18.3 preflight never ran, the critical tests are unexecuted in this environment, and `aws_ai_dlc_preflight_report` does not exist. **No scientific value becomes fillable** — TE §18.2 and §18.3's stop-and-report rule are unchanged. These shapes are design only; no module, artifact writer or test is created.
