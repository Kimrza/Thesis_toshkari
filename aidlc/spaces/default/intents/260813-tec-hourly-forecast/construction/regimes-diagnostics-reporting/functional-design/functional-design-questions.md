...
**What changed in this unit since the last receipt.** **Rec 18 limb (3) written** — the `NFR-TDEF-01` and `FR-P1-03-4` disclosure rows added to § 2, R-126 and W-4, keeping the cross-phase lineage mismatch distinct from TEC-06's comparison-geometry mismatch; `team.md` residual **discharged** by the §13 learnings ritual; **four acceptance rows approved under D-32** (FR-P1-05-16, -18, -19, `TST-CLAIMS-01`); **G-09 signed (D-31)**.
