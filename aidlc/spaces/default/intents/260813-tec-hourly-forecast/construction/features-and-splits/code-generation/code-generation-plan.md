...
- [x] **Step 1 — Change record FIRST: `governance/CHANGE_RECORD_2026-09-05_R74_R83_leakage_contracts.md`** [Q1=A, Q2=A; GOV-2026-08-22-REM-01 exit ruling]
...
- [x] **Step 2 — `src/data/splits.py` (new)** [FR-P1-04-5/WS-12/TA-11 subjects; SD-F-04, SD-F-05; R-80, R-83; W-5, W-6]
...
- [x] **Step 3 — `src/features/availability.py` (new)** [FR-P1-04-2/WS-11/TA-08 subjects; SD-F-03; R-75; W-1/W-1a]
...
- [x] **Step 4 — `src/features/build.py` + the separate loader (new)** [FR-P1-04-1/WS-10/TA-07 data-flow limb, FR-P1-04-16; SD-F-01, SD-F-02; R-76, R-78; W-2; Q3=A]
...
- [x] **Step 5 — `src/features/transforms.py` (new)** [NFR-LEAK-01/TA-11 subject; SD-F-03; R-74; W-3; BLK-04 contract now approved]
...
- [x] **Step 6 — `src/features/windows.py` (new)** [FR-P1-04-8/WS-13 subject; SD-F-06; R-81; W-4; Q4=A upstream]
...
- [x] **Step 7 — `scripts/05_build_features_and_splits.py` (new)** [W-10; §12/§13.2]
...
- [x] **Step 8 — Tests** [Q12=C M10 fixture; Q3=C limb-1 placement]
...
- [x] **Step 10 — Governance stop before commit (student acts)**
